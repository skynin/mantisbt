...
class jQueryUIPlugin extends MantisPlugin {
	...
	function resources( $p_event ) {
		$t_ajax_uri = "//ajax.googleapis.com/ajax/libs/jqueryui/".$this->version."/jquery-ui.min.js";
		...
		return '<script type="text/javascript" src="' . $t_path  . '"></script>'.PHP_EOL.
			'<link rel="stylesheet" type="text/css" href="'. plugin_file('jquery-ui-min.css') .'"/>'.PHP_EOL;
	}
}
